...
const SCHEMA_HINT = `{
  ...
  "lead": {
    "headline": "1 sentence — the lead story headline",
    "elaboration": "2-3 sentences — what was announced, key numbers/stats, why it matters",
    "takeaway": "1 sentence — strategic implication for security teams",
    "story2Headline": "story 2 / partnership / integration, phrased to follow 'We are also excited to share that ...'",
    "story2Summary": "2-3 sentences — technology, partner stack, customer benefit",
    "story2Quote": "OPTIONAL direct quote from a NAMED Fortinet leader, only if officially published; else empty string",
    "story3What": "story 3 — new product/SKU/platform, phrased to follow 'We are also announcing ...'",
    "story3Models": "model names or product line",
    "story3Benefits": "3 key technical benefits, comma-separated"
  },
  "tips": {
...
1. Top 3 Fortinet news items. Prioritize in order: (a) FortiGuard Labs threat research / Global Threat Landscape Report releases, (b) major product or partnership announcements (NVIDIA, AWS, Google, Microsoft, etc.), (c) new FortiGate / FortiAIGate / FortiOS hardware or platform launches. Use these for both the "lead" block (top 3 stories) and the "news" array (the same/related items with headline + body). Each news body: 2-4 sentences, technical-but-business audience, include the announcement date, and end with a link to the Fortinet press release or blog.
2. Lead block: 3-5 sentences total across headline/elaboration/takeaway; tie the top story to a broader defender takeaway (speed, AI, integration, zero-trust). Executive-level tone.
